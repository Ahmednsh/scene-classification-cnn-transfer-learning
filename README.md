...
| 4 | Fixed 30 blind epochs | EarlyStopping + ReduceLROnPlateau + ModelCheckpoint | Training becomes a controlled process |
| 5 | Confusion matrix on a **single batch** | Full test-set evaluation + per-class precision/recall/F1 | One batch can be wildly unrepresentative |
